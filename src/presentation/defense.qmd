...
::: {.notes}
 ...
 - We don't care about strategies, only about the value achieved by coalitions
:::


## The Shapley-value {#sec-cgt-shapley-value}
...
Same idea as with the Nash bargaining solution
 ...
 - **Bargaining foundations**
    - Subgame-perfect equilibrium of various alternating-offer bargaining games [e.g., @gul1989bargaining; @winter1994demand; @hart1996bargaining; @stole1996intra; @inderst2003bargaining]
...
::: {.notes}
 - Describes situations, such as
   ...
   - generally, any setting with an important large player and many identical small ones
:::
...
$$
\scriptsize
\varphi_P^n(f) = \frac{1}{n+1} \sum_{k=0}^{n} f(k/n)
$$
:::
...
$$
\scriptsize
\varphi_P^n(f) = \sum_{k=0}^{n} {\color{RoyalBlue}\Pr(|\mathrm{prec}P| = k)} f(k/n)
$$
:::
::: {.fragment fragment-index=2}
$$
...
::: {.fragment}
 - Cooperative games in IO
   - @hart1990property, @levy1997individual, **@montez2007downstream**
:::
...
::: {.fragment .highlight-block .smaller}
**Theorem. 2.2.**
In the benchmark model, under the hybrid regime,
...
::: {.fragment .highlight-block .smaller}
**Theorem 2.3.**
In the bargaining model, under the hybrid regime
...
Extensions: @sec-application-extensions
:::
...
::: {.notes}
 ...
 - One player being indispensable is
   - Natural
   - Maximally asymmetric → stronger effect
:::
...
- Early unstructured bargaining papers (1950s-1990s):  
  - @Kalischetal1952, @Maschler1965, @RapoportKahan1976, **@MurnighanRoth1977**, @MurnighanRoth1978, @MichenerPotter1981, **@LeopoldWildburger1992** 
  - Face-to-face bargaining, different experimental standards
:::
::: {.fragment}
- Free-form bargaining
  - @Galeottietal2018, @HossainLyonsSiow2020, **@NavarroVeszteg2020**
  - Almost always bilateral
:::
::: {.fragment}
- Multi-lateral bargaining
  - @MonteroSeftonZhang2008, @MitsutsuneTakanori2014, @TremewanVanberg2016, **@ShinodaFunaki2022**, @chessa2023experiment
  - Structured or semi-structured
:::
::: {.fragment}
- Fairness views in bargaining
  - @LuhanPoulsenRoos2019, @Schwaninger2022, **@ClippelRozen2022**
:::
::::
...
- @NavarroVeszteg2020: bilateral, chat, tests axioms (rejects scale invariance)
...
- Both are increasing in Y
  - Nucleolus is flat for low Y (no real bargaining power)
...
::: {.crossref}
Timing of agreements: @sec-timing
:::
...
Example chat messages: @sec-chat-example-stability
:::
...
# Appendix – CGT {visibility="uncounted" .unnumbered .unlisted}


## The core {visibility="uncounted" #sec-cgt-core}
...
## The nucleolus {visibility="uncounted" #sec-cgt-nucleolus}
...
::: {.fragment .smaller fragment-index=1 .fade-in-then-out}
Excess: payoff – value
$$
\begin{aligned}
e({P}) &= \pi_P \mathrel{\phantom{=2}} \\
e({A_i}) &= \pi_{A_i} - 1 \mathrel{\phantom{=1}} \\
e({P, A_i}) &= \pi_P + \pi_{A_i} - 3 \mathrel{\phantom{=1}} \\
e({A_1, A_2}) &= \pi_{A_1} + \pi_{A_2} - 2 \mathrel{\phantom{=2}}
\end{aligned}
$$
:::

::: {.fragment .smaller fragment-index=2 .fade-in}
Excess: payoff – value
$$
\begin{aligned}
e({P}) &= \pi_P \mathrel{\color{RoyalBlue}{=2}} \\
e({A_i}) &= \pi_{A_i} - 1 \mathrel{\color{RoyalBlue}{=1}} \\
e({P, A_i}) &= \pi_P + \pi_{A_i} - 3 \mathrel{\color{RoyalBlue}{=1}} \\
e({A_1, A_2}) &= \pi_{A_1} + \pi_{A_2} - 2 \mathrel{\color{RoyalBlue}{=2}}
\end{aligned}
$$
:::
...
Unique and contained in the core:
$$
\pi_P = \pi_{A_1} = \pi_{A_2} \mathrel{\color{RoyalBlue}= 2}
$$
:::
...
## Chat – Stability-based reasoning {visibility="uncounted" #sec-chat-example-stability}
